 ...
 * @date 2019/12/09
 */
public interface IShardedRepo<DO extends BaseShardedDO, Example extends BaseExample, S> {
     ...
     * @return 影响数据库行数
     */
    int deleteById(Long id, S shardingKey, String modifier);
     ...
     * @return 影响数据库行数
     */
    int deleteById(Long id, S shardingKey);
     ...
     * @return 返回结果
     */
    DO getById(Long id, S shardingKey);
     ...
     * @return 返回结果
     */
    <T> T getById(Long id, S shardingKey, Function<DO, T> function);
