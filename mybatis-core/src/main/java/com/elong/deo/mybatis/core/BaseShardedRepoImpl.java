 ...
 * @date 2019/12/09
 */
public abstract class BaseShardedRepoImpl<DO extends BaseShardedDO<S>, Example extends BaseShardedExample<S>, S> implements IShardedRepo<DO, Example, S> {

    @Autowired
    IShardedMapper<DO, Example, S> mapper;
    ...
    @Override
    public int deleteById(Long id, S shardingKey, String modifier) {
        if (id == null) {
            return 0;
        }
    ...
    @Override
    public int deleteById(Long id, S shardingKey) {
    ...
    @Override
    public DO getById(Long id, S shardingKey) {
        if (id == null) {
            return null;
        }
    ...
    @Override
    public <T> T getById(Long id, S shardingKey, Function<DO, T> function) {
