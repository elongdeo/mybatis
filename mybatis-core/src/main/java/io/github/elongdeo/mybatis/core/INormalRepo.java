 ...
 * @date 2019/12/09
 */
public interface INormalRepo<P, DO extends BaseDO<P>, Example extends BaseExample> {
     ...
     * @return 影响数据库行数
     */
    int deleteById(P id, String modifier);
     ...
     * @return 返回结果
     */
    <T> T getById(P id, Function<DO, T> function);
