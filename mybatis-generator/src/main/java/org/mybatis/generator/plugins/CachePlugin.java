...
/**
 * This plugin adds a cache element to generated sqlMaps.  This plugin is for MyBatis3 targeted runtimes only.  The
 * plugin accepts the following properties (all are optional):
 *
 * <ul>
 ...
 * are passed "as is" to the corresponding properties of the generated cache element.  All properties can be specified
 * at the table level, or on the plugin element.  The property on the table element will override any property on the
 * plugin element.
 *
