...
/**
 * This is an Ant task that will run the core. The following is a sample
 * Ant script that shows how to run the core from Ant:
 * 
 * <pre>
 ...
 *               classname="org.mybatis.core.ant.GeneratorAntTask"
 *               classpath="mybatis-core-core-x.x.x.jar" /&gt;
 ...
 * false (default), then existing Java files will be untouched and the core
 * will write new Java files with a unique name</li>
 * <li>"verbose" - if true, then the core will log progress messages to the
