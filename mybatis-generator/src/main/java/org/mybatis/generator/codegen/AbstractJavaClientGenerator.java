 ...
 * an XML core is required to match the methods in the
...
public abstract class AbstractJavaClientGenerator extends AbstractJavaGenerator {
    ...
    /**
     * Returns true is a matching XML core is required.
     * 
     * @return true if matching XML is core required
     */
    ...
    /**
     * Returns an instance of the XML core associated
     * with this client core.
     * 
     * @return the matched XML core.  May return null if no
     *     XML is required by this core
     */
