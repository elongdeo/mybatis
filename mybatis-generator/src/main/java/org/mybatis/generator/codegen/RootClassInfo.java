...
public class RootClassInfo {
    ...
    /**
     * Clears the internal map containing root class info.  This method should be called at the beginning of a
     * generation run to clear the cached root class info in case there has been a change. For example, when using the
     * eclipse launcher, the cache would be kept until eclipse was restarted.
     */
