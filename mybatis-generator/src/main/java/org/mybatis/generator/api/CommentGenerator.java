...
public interface CommentGenerator {
     ...
     * the core repeatedly, you will only retain the comment from the initial run.
     *
     ...
     * could be used to add a general file comment (such as a copyright notice). However, note
     * that the XML file merge function does not deal with this comment. If you run the core
     ...
     *            the introspected table
     * @param imports
     *   the comment core may add a required imported type to this list
     *
     * @since 1.3.6-rhino-SNAPSHOT
     */
