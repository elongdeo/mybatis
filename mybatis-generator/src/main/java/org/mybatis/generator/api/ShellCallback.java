...
public interface ShellCallback {
     ...
     *             core will not save the file it is currently working on. The core will add the exception
     ...
     * (formatted). The core will write the merged source as-is to the file
     * system.
     * 
     ...
     *             existing file will remain undisturbed. The core will add the
    ...
    /**
     * Return true if the core should overwrite an existing file if one exists.
