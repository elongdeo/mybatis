...
/**
 * Base class for all code core implementations. This class provides many of the housekeeping methods needed to
 * implement a code core, with only the actual code generation methods left unimplemented.
 *
 * @author Jeff Butler
 */
public abstract class IntrospectedTable {
    ...
    protected IntrospectedColumn shardingKeyColumn;

    protected GeneratedRepo generatedRepo;

    protected TargetRuntime targetRuntime;

    protected boolean useGeneratedKeys;

    protected boolean ignoreCriterionValueNull;

    protected int datePrecision;
    ...
    /**
     * Returns all columns in the table (for use by the select by primary key and select by example with BLOBs
     * methods).
     *
    ...
    public IntrospectedColumn getShardingKeyColumn() {
        return shardingKeyColumn;
    }

    public void setShardingKeyColumn(IntrospectedColumn shardingKeyColumn) {
        this.shardingKeyColumn = shardingKeyColumn;
    }

    public String getShardingKeyType() {
        return shardingKeyColumn == null ? null : shardingKeyColumn.getFullyQualifiedJavaType().getFullyQualifiedName();
    }
    ...
    public boolean isIgnoreCriterionValueNull() {
        return ignoreCriterionValueNull;
    }

    public void setIgnoreCriterionValueNull(boolean ignoreCriterionValueNull) {
        this.ignoreCriterionValueNull = ignoreCriterionValueNull;
    }
    ...
    public GeneratedRepo getGeneratedRepo() {
        return generatedRepo;
    }

    public void setGeneratedRepo(GeneratedRepo generatedRepo) {
    ...
    public void renameTable(String newTableName) {
        getFullyQualifiedTable().renameTableName(newTableName);
     ...
     *
     * <p>This method is called after all the setX methods, but before getNumberOfSubtasks(), getGeneratedJavaFiles,
     * and
    ...
    /**
     * Should return true if an XML core is required for this table. This method will be called during validation
