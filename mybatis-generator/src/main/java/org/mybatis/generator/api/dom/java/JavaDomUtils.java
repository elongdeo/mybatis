...
//        return compilationUnit.getImportedTypes().contains(nonGenericType);
        ...
        // 2019年11月17日09:58:30 typeHandler javaType='java.util.List<java.lang.String>' 生成的类型java.util.List<String>变成List<String>
        return compilationUnit.getImportedTypes().stream()
                .anyMatch(type -> type.getFullyQualifiedNameWithoutTypeParameters()
                        .equals(fullyQualifiedJavaType.getFullyQualifiedNameWithoutTypeParameters()));
    }
}
