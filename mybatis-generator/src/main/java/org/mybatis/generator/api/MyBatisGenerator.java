...
/**
 * This class is the main interface to MyBatis core. A typical execution of the tool involves these steps:
 * 
 * <ol>
...
public class MyBatisGenerator {
     ...
     *            then the core runs but nothing is written
     * @throws SQLException
     *             the SQL exception
     * @throws IOException
     *             Signals that an I/O exception has occurred.
        ...
        try {
            ...
            if (targetFile.exists()) {
                if (gjf.isMergeable()) {
                    ...
                    //        gjf.getFileEncoding());
                    source = JavaFileMergerJaxp.getNewJavaFile(gjf, targetFile
                        .getAbsolutePath());
     ...
     * the core to write them to disk.
     *  
