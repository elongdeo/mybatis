...
/**
 * This class creates the different objects needed by the core.
 *
 * @author Jeff Butler
 */
public class ObjectFactory {
     ...
     * that do not depend on any of the core's classes or interfaces. Examples are JDBC drivers, root classes, root
     * interfaces, etc.
     *
     * @param classLoader
     *            the class loader
