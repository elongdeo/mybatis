package com.elong.deo.mybatis.comment;
 ...
 */
public class RhinoCommentGenerator implements CommentGenerator {
    ...
    public void addJavaFileComment(CompilationUnit compilationUnit) {
        ...
        compilationUnit.addFileCommentLine(" * @author 迅犀码神");
