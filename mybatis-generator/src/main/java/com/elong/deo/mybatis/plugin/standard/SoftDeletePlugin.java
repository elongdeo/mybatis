package com.elong.deo.mybatis.plugin.standard;

import com.elong.deo.mybatis.logic.standard.SoftDeleteLogic;
...
public class SoftDeletePlugin extends PluginAdapter {
    ...
    public boolean sqlMapDeleteByPrimaryKeyElementGenerated(XmlElement element,
        ...
        SoftDeleteLogic.softDeleteSqlMapDeleteByPrimaryKey(context, element, introspectedTable);
        return true;
    }
    ...
    public boolean sqlMapSelectByPrimaryKeyElementGenerated(XmlElement element,
                                                            IntrospectedTable introspectedTable) {
        SoftDeleteLogic.softDeleteSqlMapSeleteByPrimaryKey(element);
