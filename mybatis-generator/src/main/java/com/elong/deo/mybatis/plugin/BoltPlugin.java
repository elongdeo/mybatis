...
import com.elong.deo.mybatis.constants.BoltPluginConstants;
...
public class BoltPlugin extends PluginAdapter {
    ...
    public boolean modelBaseRecordClassGenerated(TopLevelClass topLevelClass,
        ...
        if (idFiled != null) {
            ...
            topLevelClass.addImportedType("com.elong.deo.bolt.gen.GenTddlSeqId");
        }
        // 如果有bizId则引入com.elong.deo.bolt.annotation.BizIdForSelf注解类
        if (hasBizId) {
            topLevelClass.addImportedType(BoltPluginConstants.ANNOTATION_BIZ_ID_FOR_SELF);
        }
        // 如果有shardingKey则引入com.elong.deo.bolt.annotation.ShardingKey注解类
        if (hasShardingKey) {
