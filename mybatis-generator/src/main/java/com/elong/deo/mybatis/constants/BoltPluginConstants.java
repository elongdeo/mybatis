...
public class BoltPluginConstants {
     ...
     * BizIdForSelf注解类路径
     */
    public static final String ANNOTATION_BIZ_ID_FOR_SELF = "com.elong.deo.bolt.annotation.BizIdForSelf";
    /**
     * ShardingKey注解类路径
     */
    public static final String ANNOTATION_SHARDING_KEY = "com.elong.deo.bolt.annotation.ShardingKey";
    /**
     * BoltBaseDO类路径
     */
    public static final String CLASS_BOLT_BASE_DO = "com.elong.deo.bolt.model.BoltBaseDO";
    /**
     * BoltBaseMapper类路径
     */
    public static final String CLASS_BOLT_BASE_MAPPER = "com.elong.deo.bolt.mapper.BoltBaseMapper";
    /**
     * BoltBaseService类路径
     */
    public static final String CLASS_BOLT_BASE_SERVICE = "com.elong.deo.bolt.service.BoltBaseService";
    /**
     * HSFResult类路径
     */
    public static final String CLASS_HSF_RESULT = "com.elong.deo.common.result.HSFResult";
    /**
     * List类路径
     */
    ...
    public static final String CLASS_BOLT_BASE_SERVICE_IMPL
        = "com.elong.deo.bolt.service.impl.BoltMysqlServiceImpl";
    /**
     * BoltBaseHsfServiceImpl类路径
     */
    public static final String CLASS_BOLT_BASE_HSF_SERVICE_IMPL
        = "com.elong.deo.bolt.hsf.impl.BoltBaseHsfServiceImpl";
    /**
     * 属性名-是否使用lombok
     */
